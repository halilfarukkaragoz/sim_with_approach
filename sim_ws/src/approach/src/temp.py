...
def marker(data):
    ...
    marker = datimport math
 euler_from_quaternion((marker.pose.orientation.x,marker.pose.orientation.y,marker.pose.orientation.z,marker.pose.orientation.w))
    roll += pi/2
    marker.pose.orientation = quatern
...
if __name__ == "__main__":
    ...
    publisher = rospy.Publisher("/visualization_marker1",Marker,queue_size=10)
